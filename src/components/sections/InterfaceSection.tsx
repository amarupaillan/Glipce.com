  ...
  const workflowSteps = [
    {
      ...
      image: "/assets/images/cta/27.svg"
    },
    {
      title: "Kickoff",
    ...
    <div id="proceso" className="w-full py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="mb-10">
          <div
            key={activeStep}
            className="rounded-2xl shadow-xl transition-all duration-500 ease-in-out transform bg-white dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 border border-gray-100 dark:border-gray-700 shadow-gray-200/40 dark:shadow-none overflow-hidden animate-fade-in"
          >
