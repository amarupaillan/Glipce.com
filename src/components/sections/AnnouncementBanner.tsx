  ...
  return (
    <div className="w-full bg-gradient-to-r from-purple-100 via-pink-100 to-blue-100 py-3">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap justify-center items-center">
        ...
        <a href="https://calendly.com/contact-glipce/reunion-de-inicio?month=2025-09" target="_blank" rel="noopener noreferrer" className="ml-3 flex items-center text-sm font-medium text-black hover:text-gray-800">
