...
const spanishTranslations: NestedTranslations = {
  ...
  // New translations for Dental Clinic focus
  dentalClinic: {
    header: {
      links: {
        home: "Inicio",
        problems: "Soluciones",
        system: "Sistema Glipce",
    ...
    hero: {
      title: "¿Tu clínica sigue recibiendo likes… pero no pacientes?",
      subtitle: "Estás pagando por contenido, respondiendo mensajes, incluso invirtiendo en publicidad… pero tu clínica sigue sin crecer.",
      cta: "Quiero automatizar mi clínica"
    },
    problems: {
      title: "¿Cómo está tu clínica ahora?",
      painPoints: [
        "Respondes WhatsApp todo el día.",
        "No tienes tiempo para crear contenido.",
        "Contrataste una agencia, pero solo te da \"likes\".",
        "Te preguntan precios pero no te compran.",
        "No tienes un sistema ni control.",
        "Estás apagando incendios en vez de escalar."
      ],
      comparisonText: "Pero las clínicas que automatizan, crecen. Las que no, se estancan."
    },
    services: {
      title: "Sistema Glipce: el sistema que ya está funcionando en clínicas reales",
      subtitle: "Una solución completa para atraer, filtrar, convertir y retener pacientes.",
      items: [
        {
          title: "Consultoría Estratégica",
          description: "Diagnóstico, posicionamiento y planificación personalizada."
        },
        {
          title: "Producción de Contenido",
          description: "Grabación, edición y entrega de videos mensuales hechos para convertir."
        },
        {
          title: "Automatización con Tecnología",
          description: "Chatbot 24/7, CRM y página web simple que convierten mensajes en citas."
        }
      ]
    },
    guarantee: {
      title: "Cero riesgo. Todo con contrato.",
      text: "Si el sistema no genera resultados para tu clínica, te devolvemos el dinero. Todo está por contrato. Vos trabajás en tu clínica, nosotros te traemos pacientes."
    },
    cases: {
      title: "Clínicas reales. Resultados reales.",
      testimonials: [
        "Duplicamos nuestras citas en 30 días – Clínica Ejemplo",
        "Pasamos de 0 a 10 videos al mes con resultados – DentalTest",
        "Incrementamos nuestras consultas online en un 50% - Odonto+",
        "Excelente sistema de agendamiento, muy eficiente - Dra. Ana G.",
        "Redujimos el tiempo de respuesta a pacientes drásticamente - Clínica Sonrisa",
        "Hemos visto un retorno de la inversión claro en poco tiempo - Dr. Carlos M."
      ]
    },
    finalCta: {
      title: "¿Listo para dejar de responder mensajes y empezar a agendar pacientes?",
      subtitle: "Clínicas que automatizan, crecen. Las que no, siguen igual.",
      button: "Agendar reunión gratuita"
    },
    footer: {
      tagline: "Contenido & Automatización para Clínicas Dentales",
      contact: {
        email: "contact@glipce.com",
    ...
    howWeWork: {
      title: "Así funciona nuestro sistema",
      currentSituationTitle: "Tu clínica ahora",
      automatedSolutionTitle: "Con nuestro sistema",
      automatedSolutionDescription: [
        "Creación de contenido automatizada sin que muevas un dedo.",
        "Embudos de venta que convierten mensajes en citas.",
        "Sistema de agendamiento integrado 24/7."
      ],
      funnelPhases: [
        "Anuncios y redes sociales",
        "Chatbot / Calificación",
        "Cita Agendada"
      ]
    }
  }
...
const englishTranslations: NestedTranslations = {
  ...
  dentalClinic: {
    ...
    hero: {
      title: "Is your clinic still getting likes… but not patients?",
      subtitle: "You're paying for content, replying to messages, even investing in advertising… but your clinic is still not growing.",
      cta: "I want to automate my clinic"
    },
    problems: {
      title: "How is your clinic doing now?",
      painPoints: [
        "You reply to WhatsApp all day.",
        "You don't have time to create content.",
        "You hired an agency, but it only gets you 'likes'.",
        "People ask for prices but don't buy.",
        "You don't have a system or control.",
        "You're putting out fires instead of scaling."
      ],
      comparisonText: "But clinics that automate, grow. Those that don't, stay the same."
    },
    services: {
      title: "Sistema Glipce: the system that is already working in real clinics",
      subtitle: "A complete solution to attract, filter, convert, and retain patients.",
      items: [
        {
          title: "Strategic Consulting",
          description: "Diagnosis, positioning, and personalized planning."
        },
        {
          title: "Content Production",
          description: "Recording, editing, and delivery of monthly videos made to convert."
        },
        {
          title: "Automation with Technology",
          description: "24/7 Chatbot, CRM, and simple website that convert messages into appointments."
        }
      ]
    },
    guarantee: {
      title: "Zero risk. Everything under contract.",
      text: "If the system doesn't generate results for your clinic, we'll give you your money back. Everything is by contract. You work in your clinic, we bring you patients."
    },
    cases: {
      title: "Real clinics. Real results.",
      testimonials: [
        "We doubled our appointments in 30 days – Example Clinic",
        "We went from 0 to 10 videos per month with results – DentalTest",
        "Incrementamos nuestras consultas online en un 50% - Odonto+",
        "Excelente sistema de agendamiento, muy eficiente - Dra. Ana G.",
        "Redujimos el tiempo de respuesta a pacientes drásticamente - Clínica Sonrisa",
        "Hemos visto un retorno de la inversión claro en poco tiempo - Dr. Carlos M."
    ...
    finalCta: {
      title: "Ready to stop replying to messages and start booking patients?",
      subtitle: "Clinics that automate, grow. Those that don't, stay the same.",
      button: "Schedule a free meeting"
    },
    footer: {
      tagline: "Content & Automation for Dental Clinics",
      contact: {
        email: "contact@glipce.com",
    ...
    howWeWork: {
      ...
      currentSituationTitle: "Your clinic now",
      automatedSolutionTitle: "With our system",
      automatedSolutionDescription: [
        "Automated content creation without lifting a finger.",
        "Sales funnels that convert messages into appointments.",
        "Integrated 24/7 scheduling system."
      ],
      funnelPhases: [
...
export const TranslationProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const t = (key: string): any => {
    try {
      // Attempt nested lookup first for potentially complex types (objects/arrays)
      ...
      for (const part of parts) {
        if (value && typeof value === 'object' && part in value) {
          ...
          // If any part of the path is not found during nested lookup
          value = undefined;
          break;
        }
      }

      // If a value was found during nested lookup and it's not just the top-level object
      // return it directly. This handles nested strings, objects, and arrays.
      if (value !== undefined && value !== translations[language]) {
         // Also ensure that if the key was intended for a simple string, we return the string form.
         // This part might need careful consideration based on how keys are structured.
         // For now, let's return the value directly as it could be a string, object, or array.
          return value;
      }

      // If nested lookup didn't yield a specific value, fall back to flattened translations for simple string keys
      // This part might be redundant if nested lookup handles all strings, but kept for safety.
       if (flatTranslations[language] && flatTranslations[language][key]) {
         return flatTranslations[language][key];
       }

      // If not found in the current language (either nested or flattened), check in 'es' (default) using nested lookup
      if (language === 'en') {
        ...
        if (fallbackValue !== undefined) {
          return fallbackValue; // Return the found fallback value (can be string, object, or array)
        }
         // Also check flattened Spanish as a fallback for simple strings if needed
         if (flatTranslations['es'] && flatTranslations['es'][key]) {
           return flatTranslations['es'][key];
         }
      }
