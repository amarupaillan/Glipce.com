    ...
    <section id={id} className={`py-20 relative overflow-hidden border-b border-gray-200 dark:border-gray-800`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div>
            <div 
              className={`rounded-xl overflow-hidden bg-black mb-8 border ${colorMap[color].border} shadow-lg transition-all duration-300 transform max-h-[400px] flex items-center justify-center hover:scale-105`}
            >
              <img 
                src={imageSrc} 
                alt={t(title)} 
          ...
          <div>
            ...
            <div className="space-y-6">
              {problems.map((item, index) => (
                <div 
                  key={index} 
                  className={`bg-card/50 border ${colorMap[color].border} rounded-xl p-6 hover:shadow-md transition-all duration-300 hover:-translate-y-1`}
                >
